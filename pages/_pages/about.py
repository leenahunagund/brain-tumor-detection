...
def main():
    ...
    and is hosted at [Streamlit App](https://share.streamlit.io/oct4pie/brain-tumor-detection/main/app.py). 
    The source code is available at [GitHub](https://github.com/oct4pie/brain-tumor-detection).
    """
